  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      challenge: "When Demarchelier Bistro reached out, their site had been hacked and their web host suspended the domain. To anyone searching online, it looked like the restaurant was closed. For a family-owned French bistro in a tourist-driven town, that kind of outage is costly, especially on weekends when out-of-towners are deciding where to eat. The site had no backups or recovery plan, and it was running on outdated hosting with a poorly built free theme.",
      solution: "My first priority was to keep them online. I quickly jumped in, pointed their domain to my VPS, and set up a redirect to Resy so customers could keep making reservations without interruption. That quick fix bought us time to rebuild properly. In just under a week I launched a brand new site built from the ground up. A custom WordPress theme designed to reflect the atmosphere and aesthetic of their French bistro, with editable fields for announcements, menu highlights, and hours so staff can keep essential info up to date without needing a developer. I also provided short video tutorials so they had the tools to make changes themselves. The site was migrated to secure, modern hosting with SSL, automated backups, and caching for long term stability.",
      results: "The result was a polished, resilient digital home that kept reservations flowing and gave the restaurant a site that truly represents their brand. What began as a rescue ended as a full renovation, transforming a broken and outdated site into something modern, reliable, and built to last. The best part was helping a passionate family business bounce back quickly and seeing their appreciation for a product that made them proud.",
      technologies: ["WordPress", "Custom Themes", "VPS Hosting", "Security", "Backup Systems", "SSL", "Caching", "Video Training"],
      image: "/images/website0.png",
      url: "https://demarchelierrestaurant.com/"
    },
    {
